...
Our bot only gathers personally identifiable data through commands run using the bot. This information helps us provide a better user experience for all Apera's users.

The information we collect when you vote for Apera on the third-party website Discord bot list
